...
def alive_neighbors(cnt = 1)
  neighbors = []
  (1..cnt).each { neighbors << GameOfLife::CellWithCoords.new(0,0,GameOfLife::Cell.new(GameOfLife::ALIVE_CELL)) }
...
describe 'game of life' do
  ...
  describe 'dead cells' do
    before do
      @cell = GameOfLife::CellWithCoords.new(0,0,GameOfLife::Cell.new(GameOfLife::DEAD_CELL))
    end
  ...
  describe 'alive cells' do
    before do
      @cell = GameOfLife::CellWithCoords.new 0,0, GameOfLife::Cell.new(GameOfLife::ALIVE_CELL)
    end
